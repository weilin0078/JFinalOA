...
public class PinYinUtil {
    ...
    public static void main(String args[]){
    	System.out.println(PinYinUtil.converterToFirstSpell("asd李123阳"));
    	System.out.println(PinYinUtil.getAlpha("1ih是2大苏打3qwe"));
    	System.out.println(PinYinUtil.getPingYin("1ih是2大苏打3qwe"));
    }
