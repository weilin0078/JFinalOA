...
public class ChatForFriend {
    ...
    private static Map<String , ChatForFriend> webSocketMap = new HashMap<String , ChatForFriend>();//所有登录系统的用户都将会存放到set中,方便给特定用户推送消息
    //定义一个记录客户端的聊天昵称
...
//    }
    ...
    public void onOpen(Session session,EndpointConfig config) {
        ...
        webSocketMap.put(me , this);//系统登录的时候,将"我"重新放入set
