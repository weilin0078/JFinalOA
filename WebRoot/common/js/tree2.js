...
layui.define("jquery", function(e) {
			...
			i.prototype.init = function(e) {
						...
						var l = n.children && n.children.length > 0,
							...
							s = o(
									...
									function() {
										...
										return i.check&&i.check=="checkbox" ? '<input type="checkbox" name="'+i.checkboxName+'" '+((n.checked&&n.checked==true) ? 'checked="checked"' : "")+(n.checkboxValue ? ('value="' + n.checkboxValue + '"') : 'value=""') + 'data-parent-id="' + n.pid +'"' + 'id="' + n.id + '"' +(i.checkboxStyle ? ('style="' + i.checkboxStyle + '"') : "" )+' />' : "";
									}(), 
									function() {
				...
				e("tree2", function(e) {
					var r = new i(e = e || {}),
						t = o(e.elem);
					return t[0] ? void r.init(t) : a.error("layui.tree2 没有找到" + e.elem + "元素");
				})
})